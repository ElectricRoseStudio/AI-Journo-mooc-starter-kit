#!/usr/bin/env python3
# send-ledyard-docs.py
# Run the Ledyard CT agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-ledyard-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/ledyard-agendas")
TOWN_NAME  = "Ledyard, CT"
...
def run_downloader():
    print("Running download-ledyard-agendas.py ...")

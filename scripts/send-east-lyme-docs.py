#!/usr/bin/env python3
# send-east-lyme-docs.py
# Run the East Lyme CT agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-east-lyme-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/east-lyme-agendas")
CITY_NAME  = "EAST LYME"
...
def run_downloader():
    print("Running download-east-lyme-agendas.py ...")

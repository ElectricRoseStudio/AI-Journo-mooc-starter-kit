#!/usr/bin/env python3
# send-westborough-docs.py
# Run the Westborough MA agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-westborough-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/westborough-agendas")
TOWN_NAME  = "Westborough, MA"
...
def run_downloader():
    print("Running download-westborough-agendas.py ...")

#!/usr/bin/env python3
# send-bristol-twp-docs.py
# Run the Bristol Township PA agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-bristol-twp-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/bristol-twp-agendas")
TOWN_NAME  = "Bristol Township, PA"
...
def run_downloader():
    print("Running download-bristol-twp-agendas.py ...")

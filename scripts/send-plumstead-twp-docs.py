#!/usr/bin/env python3
# send-plumstead-twp-docs.py
# Run the Plumstead Township PA agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-plumstead-twp-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/plumstead-twp-agendas")
TOWN_NAME  = "Plumstead Township, PA"
...
def run_downloader():
    print("Running download-plumstead-twp-agendas.py ...")

#!/usr/bin/env python3
# send-newington-docs.py
# Run the Newington CT agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-newington-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/newington-agendas")
TOWN_NAME  = "Newington, CT"
...
def run_downloader():
    print("Running download-newington-agendas.py ...")

#!/usr/bin/env python3
# send-beverly-docs.py
# Run the Beverly MA agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-beverly-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/beverly-agendas")
TOWN_NAME  = "Beverly, MA"
...
def run_downloader():
    print("Running download-beverly-agendas.py ...")

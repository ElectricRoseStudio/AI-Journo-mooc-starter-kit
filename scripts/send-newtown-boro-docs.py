#!/usr/bin/env python3
# send-newtown-boro-docs.py
# Run the Newtown Borough PA agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-newtown-boro-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/newtown-boro-agendas")
TOWN_NAME  = "Newtown Borough, PA"
...
def run_downloader():
    print("Running download-newtown-boro-agendas.py ...")

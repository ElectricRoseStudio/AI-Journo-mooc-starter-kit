#!/usr/bin/env python3
# download-newington-agendas.py
# Download municipal meeting agendas, minutes, and video recordings from
# the Newington, CT Agenda Center for meetings within the past N days
# (and up to M days ahead).
#
# USAGE:
#   python3 scripts/download-newington-agendas.py [options]
#
# REQUIREMENTS:
...
#     1. Fetches the Newington CT Agenda Center search endpoint with a
...
#     3. Downloads PDFs to beat-archive/newington-agendas/YYYY-MM/
#
#   Video (--include-video or --video-only; off by default):
#     4. Downloads recent videos from the Town of Newington YouTube
#        channel using yt-dlp — this channel posts real, current
#        per-meeting recordings (titled e.g. "Town Plan & Zoning
#        Commission Regular Meeting Jul 22, 2026"), confirmed directly
...
# Chester/Essex/Deep River elsewhere in this repo):
#   Hub:     https://www.newingtonct.gov/AgendaCenter
#   Search:  https://www.newingtonct.gov/AgendaCenter/Search/?term=&CIDs=all
#              &startDate=MM/DD/YYYY&endDate=MM/DD/YYYY&dateRange=Custom&dateSelector=0
#   Agenda:  https://www.newingtonct.gov/AgendaCenter/ViewFile/Agenda/_MMDDYYYY-ID
#   Minutes: https://www.newingtonct.gov/AgendaCenter/ViewFile/Minutes/_MMDDYYYY-ID
#   YouTube: https://www.newingtonct.gov/youtube redirects to
#            https://www.youtube.com/channel/UCyCIn2g8yF96HNDW_d0SbaQ
...
# --- Configuration ---
BASE_URL = "https://www.newingtonct.gov"
SEARCH_URL = f"{BASE_URL}/AgendaCenter/Search/"
YOUTUBE_CHANNEL = "https://www.youtube.com/channel/UCyCIn2g8yF96HNDW_d0SbaQ"
OUTPUT_DIR = "beat-archive/newington-agendas"
DAYS_BACK = 4
DAYS_AHEAD = 7
DELAY_SECONDS = 0.8
...
UA = "Newington-CT-Agendas-Downloader/1.0 (journalism research)"
...
def main():
    parser = argparse.ArgumentParser(
        description=(
            "Download Newington CT municipal agendas, minutes, and video "
...
#    python3 scripts/download-newington-agendas.py --dry-run
#
# 2. Just Town Council:
#    python3 scripts/download-newington-agendas.py --board "Town Council"
#
# 3. PDFs only (no video — the default; --include-video/--video-only turn it on):
#    python3 scripts/download-newington-agendas.py
#
# 4. Video only:
#    python3 scripts/download-newington-agendas.py --video-only
#
# 5. Change the lookback window:
#    python3 scripts/download-newington-agendas.py --days 14
#
# 6. Run on a schedule (cron — evening):
#    0 19 * * 1-5 cd /path/to/repo && python3 scripts/download-newington-agendas.py --include-video

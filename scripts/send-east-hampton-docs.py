#!/usr/bin/env python3
# send-east-hampton-docs.py
# Run the East Hampton CT agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-east-hampton-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/east-hampton-agendas")
TOWN_NAME  = "East Hampton, CT"
...
def run_downloader():
    print("Running download-east-hampton-agendas.py ...")

#!/usr/bin/env python3
# send-wethersfield-docs.py
# Run the Wethersfield CT agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-wethersfield-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/wethersfield-agendas")
TOWN_NAME  = "Wethersfield, CT"
...
def run_downloader():
    print("Running download-wethersfield-agendas.py ...")

#!/usr/bin/env python3
# send-sudbury-docs.py
# Run the Sudbury MA agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-sudbury-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/sudbury-agendas")
TOWN_NAME  = "Sudbury, MA"
...
def run_downloader():
    print("Running download-sudbury-agendas.py ...")

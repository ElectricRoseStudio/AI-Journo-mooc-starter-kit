#!/usr/bin/env python3
# send-bridgeport-docs.py
# Run the Bridgeport CT agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-bridgeport-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive", "bridgeport-agendas")
...
def run_downloader():
    print("Running download-bridgeport-agendas.py ...")

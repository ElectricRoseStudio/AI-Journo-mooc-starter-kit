#!/usr/bin/env python3
# send-arlington-docs.py
# Run the Arlington MA agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-arlington-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/arlington-agendas")
TOWN_NAME  = "Arlington, MA"
...
def run_downloader():
    print("Running download-arlington-agendas.py ...")

#!/usr/bin/env python3
# send-andover-docs.py
# Run the Andover MA agenda downloader and email all new files.
#
# NOTE: This is Andover, MA — not North Andover MA, a separate town.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-andover-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/andover-agendas")
TOWN_NAME  = "Andover, MA"
...
def run_downloader():
    print("Running download-andover-agendas.py ...")

#!/usr/bin/env python3
# send-clinton-docs.py
# Run the Clinton CT agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-clinton-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/agendas")
CITY_NAME  = "CLINTON"
...
def run_downloader():
    print("Running download-clinton-agendas.py ...")

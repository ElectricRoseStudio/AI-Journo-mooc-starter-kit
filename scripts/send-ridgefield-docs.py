...
# Run the Ridgefield CT agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-ridgefield-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive", "ridgefield-agendas")
...
def run_downloader():
    print("Running download-ridgefield-agendas.py ...")

#!/usr/bin/env python3
# send-yardley-boro-docs.py
# Run the Yardley Borough PA agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-yardley-boro-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/yardley-boro-agendas")
TOWN_NAME  = "Yardley Borough, PA"
...
def run_downloader():
    print("Running download-yardley-boro-agendas.py ...")

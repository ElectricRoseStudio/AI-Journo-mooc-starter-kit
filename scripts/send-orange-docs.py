#!/usr/bin/env python3
# send-orange-docs.py
# Run the Orange CT agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-orange-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/orange-agendas")
CITY_NAME  = "ORANGE"
...
def run_downloader():
    print("Running download-orange-agendas.py ...")

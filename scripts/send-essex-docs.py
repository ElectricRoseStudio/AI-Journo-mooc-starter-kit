#!/usr/bin/env python3
# send-essex-docs.py
# Run the Essex CT agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-essex-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/essex-agendas")
TOWN_NAME  = "Essex, CT"
...
def run_downloader():
    print("Running download-essex-agendas.py ...")

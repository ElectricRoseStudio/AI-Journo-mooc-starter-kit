#!/usr/bin/env python3
# send-warminster-docs.py
# Run the Warminster Township PA agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-warminster-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive", "warminster-agendas")
TOWN_NAME  = "Warminster Township, PA"
...
def run_downloader():
    print("Running download-warminster-agendas.py ...")

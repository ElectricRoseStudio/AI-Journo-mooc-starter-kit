#!/usr/bin/env python3
# send-solebury-twp-docs.py
# Run the Solebury Township PA downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-solebury-twp-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/solebury-twp-agendas")
TOWN_NAME  = "Solebury Township, PA"
...
def run_downloader():
    print("Running download-solebury-twp-agendas.py ...")

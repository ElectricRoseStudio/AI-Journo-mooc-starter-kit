#!/usr/bin/env python3
# send-killingworth-docs.py
# Run the Killingworth CT agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-killingworth-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/killingworth-agendas")
TOWN_NAME  = "Killingworth, CT"
...
def run_downloader():
    print("Running download-killingworth-agendas.py ...")

#!/usr/bin/env python3
# send-bensalem-docs.py
# Run the Bensalem Township PA agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-bensalem-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive", "bensalem-agendas")
TOWN_NAME  = "Bensalem Township, PA"
...
def run_downloader():
    print("Running download-bensalem-agendas.py ...")

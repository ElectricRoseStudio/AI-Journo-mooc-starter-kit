#!/usr/bin/env python3
# send-salem-docs.py
# Run the Salem MA agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-salem-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/salem-agendas")
TOWN_NAME  = "Salem, MA"
...
def run_downloader():
    print("Running download-salem-agendas.py ...")

#!/usr/bin/env python3
# send-chester-docs.py
# Run the Chester CT agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-chester-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/chester-agendas")
TOWN_NAME  = "Chester, CT"
...
def run_downloader():
    print("Running download-chester-agendas.py ...")

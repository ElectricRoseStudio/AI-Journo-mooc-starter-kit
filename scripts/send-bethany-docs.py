#!/usr/bin/env python3
# send-bethany-docs.py
# Run the Bethany CT agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-bethany-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/bethany-agendas")
TOWN_NAME  = "Bethany, CT"
...
def run_downloader():
    print("Running download-bethany-agendas.py ...")

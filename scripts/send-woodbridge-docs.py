#!/usr/bin/env python3
# send-woodbridge-docs.py
# Run the Woodbridge CT agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-woodbridge-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/woodbridge-agendas")
TOWN_NAME  = "Woodbridge, CT"
...
def run_downloader():
    print("Running download-woodbridge-agendas.py ...")

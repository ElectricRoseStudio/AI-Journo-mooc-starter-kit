#!/usr/bin/env python3
# send-swampscott-docs.py
# Run the Swampscott MA agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-swampscott-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/swampscott-agendas")
TOWN_NAME  = "Swampscott, MA"
...
def run_downloader():
    print("Running download-swampscott-agendas.py ...")

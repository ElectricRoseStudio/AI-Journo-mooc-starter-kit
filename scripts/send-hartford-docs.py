#!/usr/bin/env python3
# send-hartford-docs.py
# Run the Hartford CT agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-hartford-agendas.py")
...
def run_downloader():
    print("Running download-hartford-agendas.py ...")

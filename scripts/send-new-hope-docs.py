#!/usr/bin/env python3
# send-new-hope-docs.py
# Run the New Hope Borough PA agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-new-hope-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/new-hope-agendas")
TOWN_NAME  = "New Hope Borough, PA"
...
def run_downloader():
    print("Running download-new-hope-agendas.py ...")

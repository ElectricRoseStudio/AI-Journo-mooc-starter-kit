#!/usr/bin/env python3
# send-milford-ma-docs.py
# Run the Milford MA agenda downloader and email all new files.
#
# NOTE ON NAMING: This repo already has send-milford-docs.py for Milford,
# CT. This script uses the "-ma" suffix to avoid colliding with it.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-milford-ma-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/milford-ma-agendas")
TOWN_NAME  = "Milford, MA"
...
def run_downloader():
    print("Running download-milford-ma-agendas.py ...")

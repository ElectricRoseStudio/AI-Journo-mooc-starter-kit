#!/usr/bin/env python3
# send-west-hartford-docs.py
# Run the West Hartford CT agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-west-hartford-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive", "west-hartford-agendas")
...
def run_downloader():
    print("Running download-west-hartford-agendas.py ...")

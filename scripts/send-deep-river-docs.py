#!/usr/bin/env python3
# send-deep-river-docs.py
# Run the Deep River CT agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-deep-river-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/deep-river-agendas")
TOWN_NAME  = "Deep River, CT"
...
def run_downloader():
    print("Running download-deep-river-agendas.py ...")

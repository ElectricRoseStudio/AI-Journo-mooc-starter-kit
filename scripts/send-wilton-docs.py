#!/usr/bin/env python3
# send-wilton-docs.py
# Run the Wilton CT agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-wilton-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive", "wilton-agendas")
CITY_NAME  = "WILTON"
...
def run_downloader():
    print("Running download-wilton-agendas.py ...")

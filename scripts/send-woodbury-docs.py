#!/usr/bin/env python3
# send-woodbury-docs.py
# Run the Woodbury CT agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-woodbury-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/woodbury-agendas")
TOWN_NAME  = "Woodbury, CT"
...
def run_downloader():
    print("Running download-woodbury-agendas.py ...")
    result = subprocess.run(
        [sys.executable, SCRIPT, "--include-media"],
        capture_output=True,
        text=True,
        cwd=REPO_DIR,
    )

#!/usr/bin/env python3
# send-bristol-boro-docs.py
# Run the Bristol Borough PA agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-bristol-boro-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/bristol-boro-agendas")
TOWN_NAME  = "Bristol Borough, PA"
...
def run_downloader():
    print("Running download-bristol-boro-agendas.py ...")
...
def send_email(files, downloader_output):
    ...
    body = (
        f"{TOWN_NAME} agenda/video download — "

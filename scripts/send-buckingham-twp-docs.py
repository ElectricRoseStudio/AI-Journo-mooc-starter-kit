#!/usr/bin/env python3
# send-buckingham-twp-docs.py
# Run the Buckingham Township PA agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-buckingham-twp-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/buckingham-twp-agendas")
TOWN_NAME  = "Buckingham Township, PA"
...
def run_downloader():
    print("Running download-buckingham-twp-agendas.py ...")

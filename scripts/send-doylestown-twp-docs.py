#!/usr/bin/env python3
# send-doylestown-twp-docs.py
# Run the Doylestown Township PA agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-doylestown-twp-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/doylestown-twp-agendas")
TOWN_NAME  = "Doylestown Township, PA"
...
def run_downloader():
    print("Running download-doylestown-twp-agendas.py ...")

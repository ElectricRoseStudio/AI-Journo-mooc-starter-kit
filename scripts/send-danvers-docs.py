#!/usr/bin/env python3
# send-danvers-docs.py
# Run the Danvers MA agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-danvers-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/danvers-agendas")
TOWN_NAME  = "Danvers, MA"
...
def run_downloader():
    print("Running download-danvers-agendas.py ...")

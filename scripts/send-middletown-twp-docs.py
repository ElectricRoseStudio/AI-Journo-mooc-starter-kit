#!/usr/bin/env python3
# send-middletown-twp-docs.py
# Run the Middletown Township PA agenda downloader and email all new files.
#
# CONFIGURATION:
...
TO_ADDRESS   = "dino.ciliberti@patch.com"

REPO_DIR   = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
LOG_PATH   = os.path.join(REPO_DIR, "beat-archive", "send-log.txt")
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-middletown-twp-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive", "middletown-twp-agendas")
TOWN_NAME  = "Middletown Township, PA"
...
def run_downloader():
    print("Running download-middletown-twp-agendas.py ...")

#!/usr/bin/env python3
# send-waterford-docs.py
# Run the Waterford CT agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-waterford-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/waterford-agendas")
CITY_NAME  = "WATERFORD"
...
def run_downloader():
    print("Running download-waterford-agendas.py ...")

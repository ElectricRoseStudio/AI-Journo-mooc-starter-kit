#!/usr/bin/env python3
# send-portland-docs.py
# Run the Portland CT agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-portland-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/portland-agendas")
TOWN_NAME  = "Portland, CT"
...
def run_downloader():
    print("Running download-portland-agendas.py ...")

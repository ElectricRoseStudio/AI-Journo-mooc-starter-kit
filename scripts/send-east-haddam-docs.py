#!/usr/bin/env python3
# send-east-haddam-docs.py
# Run the East Haddam CT agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-east-haddam-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/east-haddam-agendas")
TOWN_NAME  = "East Haddam, CT"
...
def run_downloader():
    print("Running download-east-haddam-agendas.py ...")

#!/usr/bin/env python3
# send-wrightstown-twp-docs.py
# Run the Wrightstown Township PA agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-wrightstown-twp-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/wrightstown-twp-agendas")
TOWN_NAME  = "Wrightstown Township, PA"
...
def run_downloader():
    print("Running download-wrightstown-twp-agendas.py ...")

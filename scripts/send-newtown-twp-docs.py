#!/usr/bin/env python3
# send-newtown-twp-docs.py
# Run the Newtown Township PA agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-newtown-twp-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/newtown-twp-agendas")
TOWN_NAME  = "Newtown Township, PA"

ATTACH_EXTENSIONS = {".pdf", ".mp4", ".mkv", ".webm"}
...
def run_downloader():
    print("Running download-newtown-twp-agendas.py ...")

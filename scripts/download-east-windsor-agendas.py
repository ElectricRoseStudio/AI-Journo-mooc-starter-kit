#!/usr/bin/env python3
# download-east-windsor-agendas.py
# Download municipal meeting agendas and minutes from East Windsor CT for meetings
...
#
# USAGE:
#   python3 scripts/download-east-windsor-agendas.py [options]
#
# REQUIREMENTS:
...
#
# WHAT IT DOES:
#   1. Fetches the East Windsor CT Agenda Center hub page to discover all board
#      category IDs (31 boards)
...
#   4. Downloads PDFs to beat-archive/east-windsor-agendas/YYYY-MM/
...
#   7. Appends a download log to beat-archive/east-windsor-agendas/download-log.txt
#
# SITE STRUCTURE:
#   AgendaCenter (CivicPlus CivicEngage):
#     Hub:    https://www.eastwindsor-ct.gov/agendacenter
...
#
#   YouTube channel: UCgNSFYXWvjpaYULSt-XoZOA (Town of East Windsor)
#     RSS: https://www.youtube.com/feeds/videos.xml?channel_id=UCgNSFYXWvjpaYULSt-XoZOA
#     All videos on this channel are East Windsor municipal meetings — no title
#     filtering needed. The RSS feed returns the most recent ~15 videos. Run
#     this script regularly (daily or weekly) to avoid missing recordings.
#
# BOARDS (31 categories):
#   Ad Hoc School Facilities Committee, Agricultural Commission,
#   American Heritage River Commission, Aquifer Protection Agency,
#   Arts and Culture Committee, BMX Committee,
#   Board of Assessment Appeals, Board of Education, Board of Finance,
#   Board of Selectmen, Building Commission,
#   Capital Improvement Planning Committee, Charter Revision Commission,
#   Conservation Commission, East Windsor Housing Authority,
#   Economic Development Commission, Elderly Commission,
#   Inland Wetlands & Watercourses Agency, Parks & Recreation Commission,
#   Pension & Retirement Board, Planning & Zoning Commission,
#   Police Commission, Public Hearings, Town Meeting,
#   Town of East Windsor, Town of East Windsor - Broad Brook Fire Department,
#   Town of East Windsor Charter Revision Commission, Veterans Commission,
#   Warehouse Point Fire District, Water Pollution Control Authority,
...
def main():
    parser = argparse.ArgumentParser(
        description=(
            "Download East Windsor CT municipal agendas, minutes, and meeting "
...
#    python3 scripts/download-east-windsor-agendas.py --dry-run
#
# 2. Narrow to one board:
#    python3 scripts/download-east-windsor-agendas.py --board "Board of Selectmen"
#
# 3. PDFs only (no video downloads):
#    python3 scripts/download-east-windsor-agendas.py --docs-only
#
# 4. Videos only:
#    python3 scripts/download-east-windsor-agendas.py --videos-only
#
# 5. Agendas only (skip minutes):
#    python3 scripts/download-east-windsor-agendas.py --no-minutes
#
# 6. Change the lookback window:
#    python3 scripts/download-east-windsor-agendas.py --days 7
#
# 7. Save files somewhere else:
#    python3 scripts/download-east-windsor-agendas.py --output-dir ~/Downloads/east-windsor
#
# 8. Run on a schedule (cron — 7 AM daily):
#    0 7 * * * cd /path/to/repo && python3 scripts/download-east-windsor-agendas.py
#
# NOTES:
#   - East Windsor CT uses CivicPlus CivicEngage. All board rows are embedded
...
#       /AgendaCenter/ViewFile/Agenda/_05072026-123 → May 7, 2026
#   - YouTube videos are sourced from channel UCgNSFYXWvjpaYULSt-XoZOA, the
#     Town of East Windsor's own channel. All videos are municipal meetings
#     (Board of Selectmen, Planning & Zoning, Board of Finance, Charter
#     Revision Commission, Inland Wetlands, Town Meeting, and others).
#     The feed returns the latest ~15 videos. Run at least weekly.

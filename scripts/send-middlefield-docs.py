#!/usr/bin/env python3
# send-middlefield-docs.py
# Run the Middlefield CT agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-middlefield-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/middlefield-agendas")
TOWN_NAME  = "Middlefield, CT"
...
def run_downloader():
    print("Running download-middlefield-agendas.py ...")

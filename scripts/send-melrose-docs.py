#!/usr/bin/env python3
# send-melrose-docs.py
# Run the Melrose MA agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-melrose-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/melrose-agendas")
TOWN_NAME  = "Melrose, MA"
...
def run_downloader():
    print("Running download-melrose-agendas.py ...")

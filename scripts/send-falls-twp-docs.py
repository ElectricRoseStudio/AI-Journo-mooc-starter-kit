#!/usr/bin/env python3
# send-falls-twp-docs.py
# Run the Falls Township PA agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-falls-twp-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/falls-twp-agendas")
TOWN_NAME  = "Falls Township, PA"
...
def run_downloader():
    print("Running download-falls-twp-agendas.py ...")

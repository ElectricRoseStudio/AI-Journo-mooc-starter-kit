#!/usr/bin/env python3
# send-norwich-docs.py
# Run the Norwich CT agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-norwich-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/norwich-agendas")
...
def run_downloader():
    print("Running download-norwich-agendas.py ...")

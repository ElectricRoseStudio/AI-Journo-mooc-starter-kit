#!/usr/bin/env python3
# send-middlebury-docs.py
# Run the Middlebury CT agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-middlebury-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/middlebury-agendas")
TOWN_NAME  = "Middlebury, CT"
...
def run_downloader():
    print("Running download-middlebury-agendas.py ...")

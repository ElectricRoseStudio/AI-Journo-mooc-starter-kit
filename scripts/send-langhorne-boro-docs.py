#!/usr/bin/env python3
# send-langhorne-boro-docs.py
# Run the Langhorne Borough PA agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-langhorne-boro-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/langhorne-boro-agendas")
TOWN_NAME  = "Langhorne Borough, PA"
...
def run_downloader():
    print("Running download-langhorne-boro-agendas.py ...")

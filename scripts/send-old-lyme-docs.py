#!/usr/bin/env python3
# send-old-lyme-docs.py
# Run the Old Lyme CT agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-old-lyme-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/old-lyme-agendas")
CITY_NAME  = "OLD LYME"
...
def run_downloader():
    print("Running download-old-lyme-agendas.py ...")

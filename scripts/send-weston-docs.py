#!/usr/bin/env python3
# send-weston-docs.py
# Run the Weston CT agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-weston-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive", "weston-agendas")
CITY_NAME  = "WESTON"

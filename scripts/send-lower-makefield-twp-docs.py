#!/usr/bin/env python3
# send-lower-makefield-twp-docs.py
# Run the Lower Makefield Township PA agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-lower-makefield-twp-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/lower-makefield-twp-agendas")
TOWN_NAME  = "Lower Makefield Township, PA"
...
def run_downloader():
    print("Running download-lower-makefield-twp-agendas.py ...")

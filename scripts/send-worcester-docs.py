#!/usr/bin/env python3
# send-worcester-docs.py
# Run the Worcester MA agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-worcester-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/worcester-agendas")
TOWN_NAME  = "Worcester, MA"
...
def run_downloader():
    print("Running download-worcester-agendas.py ...")

#!/usr/bin/env python3
# send-medford-docs.py
# Run the Medford MA agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-medford-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/medford-agendas")
TOWN_NAME  = "Medford, MA"
...
PARKS_COMMISSION_NOTE = (
    "Note: Parks Commission (Medford's only Parks & Recreation-equivalent "
    "board) is not covered by this pipeline. Its agendas live in a Google "
    "Drive folder that requires sign-in to view and was last updated "
    "September 2024 — there's no automatable public source for it. "
    "City Council (+ subcommittees) and School Committee are both covered.\n"
)
...
def run_downloader():
    print("Running download-medford-agendas.py ...")

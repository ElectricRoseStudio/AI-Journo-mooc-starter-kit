#!/usr/bin/env python3
# send-upper-makefield-twp-docs.py
# Run the Upper Makefield Township PA agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-upper-makefield-twp-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/upper-makefield-twp-agendas")
TOWN_NAME  = "Upper Makefield Township, PA"
...
def run_downloader():
    print("Running download-upper-makefield-twp-agendas.py ...")

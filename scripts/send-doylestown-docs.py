#!/usr/bin/env python3
# send-doylestown-docs.py
# Run the Doylestown PA Borough agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-doylestown-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/doylestown-agendas")
TOWN_NAME  = "Doylestown Borough, PA"
...
def run_downloader():
    print("Running download-doylestown-agendas.py ...")

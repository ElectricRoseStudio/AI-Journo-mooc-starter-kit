#!/usr/bin/env python3
# send-lyme-docs.py
# Run the Lyme CT agenda downloader and email all new files.
#
# CONFIGURATION:
...
SCRIPT     = os.path.join(REPO_DIR, "scripts", "download-lyme-agendas.py")
OUTPUT_DIR = os.path.join(REPO_DIR, "beat-archive/lyme-agendas")
CITY_NAME  = "LYME"
...
def run_downloader():
    print("Running download-lyme-agendas.py ...")
